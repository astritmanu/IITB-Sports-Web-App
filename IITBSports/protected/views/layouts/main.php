				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="index.php?r=events/page&view=trip">Trip of the Month</a></li>
							<li class="active"><a href="index.php?r=events/page&view=sport">Sport of the Month</a></li>
					...
					<div class="col-md-2 widget">
						...
						<div class="widget-body">
							<p class="follow-me-icons">
								...
								<a href="https://www.facebook.com/iitbsports" target="_blank"><i class="fa fa-facebook fa-2"></i></a>
