...
<?php include 'sidebar.php'; ?>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden; ">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
            <div>
                <img u="image" src="images/gallery/skating/1.jpg" />
            </div>
            <div>
                <img u="image" src="images/gallery/skating/2.jpg" />
            </div>
            <div>
                <img u="image" src="images/gallery/skating/3.jpg" />
            </div>
            <div>
                <img u="image" src="images/gallery/skating/4.jpg" />
            </div>
            <div>
                <img u="image" src="images/gallery/skating/5.jpg" />
            </div>
        </div>
