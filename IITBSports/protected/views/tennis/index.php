...
<?php include 'sidebar.php'; ?>
    ...
    <!-- Jssor Slider End -->
				...
				<p>Scientists and doctors around the world point to tennis as one of the healthiest activities that one can 
                participate in because it delivers physical, mental and emotional gains. Tennis engages your 
                mind and body at the same time, unlike a traditional workout in the gym and is hence a more 
                fun way for a workout. From playing tennis one can develop a work ethic, learn sportsmanship, 
                accept responsibility, manage mistakes, enhance discipline, learn to compete, cope with pressure 
                and adversity, develop healthy habits and more, skills which are beyond the realm of academics.</p>
                
                <p>Since its inception, the Tennis Club of IIT-B has been a hub for tennis enthusiasts. The 
