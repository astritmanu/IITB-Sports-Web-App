...
<?php include 'sidebar.php'; ?>
    ...
    <!-- Jssor Slider End -->
				...
				<p>For all badminton loving folks of IIT Bombay. Founded a year ago. It has been one of the 
                most active clubs handling the most active sport in the institute.</p>
                <p>With promotion of Badminton as its true motive, it has organised a wide range of events in 
                its first year of inception itself. This year its gonna be bigger and better.</p>
                <p>Headed by the Badminton Secretary and driven by the conveners, Badminton Club will be one of 
